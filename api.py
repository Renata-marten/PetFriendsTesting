...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и его результат в формате json с уникальным ключом пользователя, по указанным email и паролю"""
        headers = {
            'email': email,
            'password': password
        }
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        """Метод делает запрос к API сервера и возвращает статус запроса и его результат - список питомцев, найденных по фильтру - в формате json"""
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: str, pet_photo: str) -> json:
        """Метод отправляет на сервер данные о новом питомце включая фото и возвращает статус
